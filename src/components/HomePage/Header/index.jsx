    ...
    <header className='header scroll-header' id='header'>
      <nav className='nav container'>
            ...
            {content.links.map((link) => (
              <li className='nav__item' key={link.href}>
                <a href={`#${link.href}`} className='nav__link' onClick={onToggleMenu}>
                  <i className={`uil ${link.icon} nav__icon`}></i> {link.text}
                </a>
              </li>
            ))}
          </ul>
        ...
        <div className='nav__btns'>
          <div className='nav__toggle' id='nav-toggle' onClick={onToggleMenu}>
            <i className={`uil ${toggleMenu ? 'uil-times nav__close' : 'uil-apps'}`}></i>
          </div>
        </div>
      </nav>
    </header>
